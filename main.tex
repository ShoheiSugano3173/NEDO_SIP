...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\jtitle{戦略的イノベーション創造プログラム（ＳＩＰ）第２期／\\ビッグデータ・ＡＩを活用したサイバー空間基盤技術／介護支援技術}{}
\etitle{排泄センサーを基軸とした介護者支援システムの開発}{}
...
\authora{第１８１０２０７０－０号}{}{}
%
\datestamp{2019}{3}
%
\headshorttitle{排泄センサーを基軸とした介護者支援システムの開発}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 絶対に読み込まなければならないスタイル
%  順番を他の位置にしないほうが良い．
